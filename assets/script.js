...
const I18N = {
  en: {
    ...
    "hero.b5": "Remote contract / Full-time",
  ...
  es: {
    ...
    "hero.b5": "Contrato remoto / Tiempo completo",
    ...
    "about.p2": "Actualmente lidero la entrega como Gerente de Proyecto después de cuatro años como Líder de QA — puente entre ingeniería, partes interesadas y calidad. Mi trabajo combina operaciones de QA basadas en evidencia, disciplina de entrega y diseño de flujos potenciados por IA.",
    ...
    "skills.s5d": "Gerencia de proyecto hoy; planificación de sprints, gestión de riesgos, reportería para partes interesadas y marcos de escalamiento.",
    ...
    "exp.r2": "Construí y lideré la función de QA para un portafolio de 30+ productos que abarcó iniciativas web, móviles, de escritorio y de entrega de software. Definí una estrategia unificada de QA alineada con ISTQB, Scrum y CMMI; lideré planificación basada en riesgo que redujo en 20% los defectos posteriores a liberación; y dirigí pruebas multiplataforma que elevaron a 60% la detección de defectos antes de UAT.",
    ...
    "contact.lead": "Estoy disponible para trabajo de liderazgo en ingeniería de calidad y entrega potenciada por IA con equipos distribuidos de software — contrato o remoto a tiempo completo.",
