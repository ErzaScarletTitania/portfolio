...
const I18N = {
  en: {
    ...
    "about.p2": "I currently lead QA at ecoPortal (New Zealand), a 6-person team supporting 9 product squads, alongside a contract engagement as Project Manager & QA Lead — bridging engineering, stakeholders, and quality. My work combines evidence-based QA operations, delivery discipline, and AI-enabled workflow design.",
    ...
    "exp.h0r": "QA Lead",
    "exp.h0c": "ecoPortal · New Zealand · Remote",
    "exp.h0d": "Jul 2026 — Present",
    "exp.h1r": "Project Manager & QA Lead",
    "exp.h1c": "Cuban Engineer · Contract · Remote",
    "exp.h1d": "Sep 2025 — Present",
    "exp.h2r": "QA Lead",
    "exp.h2c": "Cuban Engineer · Remote",
    "exp.h2d": "Sep 2021 — Aug 2025",
    "exp.h3r": "B2B Sales Representative",
    "exp.h3c": "Universidad de Ciencias Informáticas (UCI)",
    "exp.h3d": "Sep 2020 — Aug 2021",
    "exp.h4r": "Technical Sales Specialist",
    "exp.h4c": "Universidad de Ciencias Informáticas (UCI)",
    "exp.h4d": "Apr 2019 — Aug 2020",
    "exp.h5r": "University Lecturer (Part-Time)",
    "exp.h5c": "Universidad de Ciencias Informáticas (UCI)",
    "exp.h5d": "Sep 2017 — Aug 2021",
    "exp.h6r": "SEO Specialist",
    "exp.h6c": "Universidad de Ciencias Informáticas (UCI)",
    ...
    "exp.r2": "Built and led the QA function for a 30+ product portfolio spanning web, mobile, desktop, and software delivery initiatives, leading a 3-person QA team. I defined a unified QA strategy aligned with ISTQB, Scrum, and CMMI; led risk-based test planning that reduced post-release defects by 20%; directed cross-platform testing that raised pre-UAT defect detection to 60%; and cut manual regression effort by ~30% per release cycle.",
  ...
  es: {
    ...
    "about.p2": "Actualmente lidero QA en ecoPortal (Nueva Zelanda), un equipo de 6 personas que da soporte a 9 squads de producto, en paralelo a un contrato como Gerente de Proyecto y Líder de QA — puente entre ingeniería, partes interesadas y calidad. Mi trabajo combina operaciones de QA basadas en evidencia, disciplina de entrega y diseño de flujos potenciados por IA.",
    ...
    "exp.h0r": "Líder de QA",
    "exp.h0c": "ecoPortal · Nueva Zelanda · Remoto",
    "exp.h0d": "Jul 2026 — Presente",
    "exp.h1r": "Gerente de Proyecto y Líder de QA",
    "exp.h1c": "Cuban Engineer · Contrato · Remoto",
    "exp.h1d": "Sep 2025 — Presente",
    "exp.h2r": "Líder de QA",
    "exp.h2c": "Cuban Engineer · Remoto",
    ...
    "exp.r2": "Construí y lideré la función de QA para un portafolio de 30+ productos que abarcó iniciativas web, móviles, de escritorio y de entrega de software, liderando un equipo de QA de 3 personas. Definí una estrategia unificada de QA alineada con ISTQB, Scrum y CMMI; lideré planificación basada en riesgo que redujo en 20% los defectos posteriores a liberación; dirigí pruebas multiplataforma que elevaron a 60% la detección de defectos antes de UAT; y reduje ~30% el esfuerzo de regresión manual por ciclo de liberación.",
